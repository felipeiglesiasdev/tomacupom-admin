...
class CupomController extends Controller
{
    ...
    {
        return view('cupons.create', ['lojas' => Loja::query()->select(['id_loja', 'nome'])->ordenadas()->get()]);
    }
    ...
    {
        return view('cupons.edit', ['cupom' => $cupom, 'lojas' => Loja::query()->select(['id_loja', 'nome'])->ordenadas()->get()]);
    }
